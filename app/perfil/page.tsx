...
import { Settings, CreditCard, MapPin, LogOut, LogIn } from "lucide-react";
  ...
  if (!user) {
    return (
      <div className="p-8 bg-gray-50 min-h-[80vh] flex flex-col items-center justify-center text-center">
        {/* ... (código igual ao anterior para estado deslogado) ... */}
        <h1 className="text-2xl font-bold text-blue-900 mb-2">Você não está logado</h1>
        <p className="text-gray-500 mb-8 max-w-xs">Entre na sua conta para ver seus pedidos e configurações.</p>
        <button 
  ...
  return (
    <div className="p-4 bg-gray-50 min-h-full pb-24">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm mb-6 flex items-center gap-4 border border-gray-100">
        {/* CORREÇÃO DA IMAGEM: referrerPolicy ajuda a carregar fotos do Google */}
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100">
        ...
        <div className="p-4 border-b border-gray-100 flex items-center gap-3 hover:bg-gray-50 cursor-pointer transition">
